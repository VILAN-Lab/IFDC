...
def train(opt):
    ...
    try:
        while True:
            ...
            optimizer.zero_grad()
            model_out = dp_lw_model(semantic_feat, semantic1_feat, att_feats, att1_feats, box_feat, box1_feat, labels, masks, data['gts'], torch.arange(0, len(data['gts'])), sc_flag, struc_flag)
