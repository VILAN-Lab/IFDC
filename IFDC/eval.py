...
# Input paths
parser.add_argument('--model', type=str, default='./checkpoint/model-best.pth',
                help='path to model to evaluate')
parser.add_argument('--infos_path', type=str, default='./checkpoint/infos_up-best.pkl',
...
replace = ['input_att_dir', 'input_box_dir', 'input_label_h5', 'input_json', 'batch_size', 'id', "input_att1_dir", "input_box1_dir"]
ignore = ['start_from']
