...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--input_json', type=str, default='./data/output.json',
                    help='path to the json file containing additional info and vocab')
    parser.add_argument('--input_att_dir', type=str, default='./data/bottom_up_att',
                    help='path to the directory containing the preprocessed default att feats')
    parser.add_argument('--input_box_dir', type=str, default='./data/bottom_up_box',
                    help='path to the directory containing the boxes of default att feats')
    parser.add_argument('--input_label_h5', type=str, default='./data/output_label.h5',
                    help='path to the h5file containing the preprocessed dataset')
    parser.add_argument('--input_att1_dir', type=str, default='./data/bottom_up_att1',
                        help='path to the directory containing the preprocessed semantic att feats')
    parser.add_argument('--input_box1_dir', type=str, default='./data/bottom_up_box1',
                        help='path to the directory containing the boxes of semantic att feats')
    parser.add_argument('--start_from', type=str, default="./checkpoint",
    ...
    parser.add_argument('--input_encoding_size', type=int, default=300,
    ...
    parser.add_argument('--seq_per_img', type=int, default=2,
    ...
    parser.add_argument('--scheduled_sampling_start', type=int, default=100,
    ...
    parser.add_argument('--save_every_epoch', action='store_false',
    ...
    # misc
    parser.add_argument('--id', type=str, default='up',
    ...
    parser.add_argument('--entropy_reward_weight', type=float, default=1,
    ...
    parser.add_argument('--train_sample_n', type=int, default=3,
                    help='The reward weight from cider')
...
def add_eval_options(parser):
    ...
    parser.add_argument('--input_att_dir', type=str, default='./data/bottom_up_att',
                    help='path to the h5file containing the preprocessed default dataset')
    parser.add_argument('--input_box_dir', type=str, default='./data/bottom_up_box',
                    help='path to the h5file containing the preprocessed default dataset')
    parser.add_argument('--input_att1_dir', type=str,
                        default='./data/bottom_up_att1',
                        help='path to the h5file containing the preprocessed semantic dataset')
    parser.add_argument('--input_box1_dir', type=str,
